...
from second_project.settings import EMAIL_HOST_USER
from django.core.mail import send_mail
from newuser.helpers import get_user_by_id_function
...
def send_email_to_follower_about_added_product(data):
    try:
...
def get_follower_by_stores_function(data):
    try:
        ...
        followers = StoreObj.get_followers()
        return followers, True, "Successful"
    except ObjectDoesNotExist:
        return None, False, "Invalid Id"
    except Exception as e:
        print(e)
